 ...
 */
class getUserTestRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\UserTestRepository' shared autowired service.
     *
     * @return \App\Repository\UserTestRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'UserTestRepository.php';

        return $container->privates['App\\Repository\\UserTestRepository'] = new \App\Repository\UserTestRepository(($container->services['doctrine'] ?? $container->getDoctrineService()));
    }
}
